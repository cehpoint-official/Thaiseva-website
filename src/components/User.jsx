    ...
    return <div >
        <div className='flex-col text-center items-center  lg:mt-40 mt-20'>
            <p className='md:text-4xl text-3xl font-semibold '>
                ...
                WHAT  <span className='text-yellow-500 '>THAISEVA </span>
                USERS SAY
            </p>
        ...
        <div className='grid grid-cols-12 m-10 gap-6'>
            <div className='col-span-12 md:col-span-6 lg:col-span-4 transition duration-700 ease-in-out bg-slate-200 hover:bg-black hover:text-white rounded-xl shadow-xl p-6'>
                <p className='text-2xl mb-4 font-bold'>Simple & Useful!</p>
                <p className='mt-1 text-slate-500'> Aliquam augue suscipit luctus neque purus ipsum neque dolor primis libero tempus.</p>
                <p className='mt-1 text-slate-500'>blandit posuere ligula varius magna congue at cursus porta luctus neque purus ipsum neque and dolor primis libero tempus, blandit posuere ligula varius magna.</p>
            ...
            <div className='col-span-12 md:col-span-6 lg:col-span-4 transition duration-700 ease-in-out bg-slate-200 hover:bg-black hover:text-white rounded-xl shadow-xl p-6'>
                <p className='text-2xl mb-4 font-bold'>Useful, Elegant and Effective</p>
                <p className='mt-1 text-slate-500'> Aliquam augue suscipit luctus neque purus ipsum neque dolor primis libero tempus.</p>
                <p className='mt-1 text-slate-500'>blandit posuere ligula varius magna congue at cursus porta luctus neque purus ipsum neque and dolor primis libero tempus, blandit posuere ligula varius magna.</p>
            ...
            <div className='col-span-12 md:col-span-6 lg:col-span-4 transition duration-700 ease-in-out  md:col-start-4 bg-slate-200 hover:bg-black hover:text-white rounded-xl shadow-xl p-6'>
                <p className='text-2xl mb-4 font-bold'>I Love This App</p>
                <p className='mt-1 text-slate-500'> Aliquam augue suscipit luctus neque purus ipsum neque dolor primis libero tempus.</p>
                <p className='mt-1 text-slate-500'>blandit posuere ligula varius magna congue at cursus porta luctus neque purus ipsum neque and dolor primis libero tempus, blandit posuere ligula varius magna.</p>
