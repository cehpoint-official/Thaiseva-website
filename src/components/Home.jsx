...
const Home = () => {
    return <div className='overflow-x-hidden'>
        <div className='backImg'>
            <div className=' bg-slate-950 bg-opacity-95 '>
                <Navbar />
                <div className='px-10'>
                    <div className='grid grid-cols-12'>
                        <div className='lg:col-span-4 md:col-span-12 col-span-12 flex justify-center items-center'>
                            <div>
                                <p className='text-white text-5xl mt-16'>GET THIS APP FOR FREE </p>
                                <p className='text-white mt-10'>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti ex esse cumque,
                                </p>
                                <div className='flex gap-6 mt-10'>
                                    <button>
                                        <img className='lg:h-[3.5rem] md:h-[3.2rem] h-14' src={googlePay} alt="" />
                                    </button>
                                    <button>
                                        <img className='lg:h-[3.5rem] md:h-[3.2rem] h-14' src={AppStore} alt="" />
                                    </button>
                                </div>
                            </div>
                        </div>
        ...
        <div className='grid grid-cols-12 p-10 md:gap-14 my-14 relative'>
            ...
            <div className='h-[5px] w-28 bg-yellow-100 absolute rotate-45 -bottom-5 -right-5 rounded-lg'></div>
            <div className='h-[5px] w-24 bg-slate-100 absolute rotate-45 bottom-2 -right-4 rounded-lg'></div>
            <div className='md:col-span-6 col-span-12 relative'>
                <img src={WorkImg} alt="" className='w-full md:h-[24rem] shadow-yellow-800 rounded-2xl' />
            </div>
            <div className='md:col-span-6 col-span-12 md:mt-0 mt-10'>
                <strong className='text-3xl flex space-x-2 mb-6'> How
                ...
                <div className='lg:flex flex md:block mt-10 items-center gap-6'>
                    <div className='font-bold relative'>
                        <div className=''></div>
                        <p className=''>Watch shortly how this</p>
                        <p> app work</p>
                        <div className='bg-yellow-200 h-10 w-10 rounded-3xl absolute top-0 -left-6 -z-10 border border-blue-200'>

                        </div>
                        <div className='bg-yellow-200 h-10 w-10 rounded-3xl absolute top-1 left-2 -z-10'>
